...
def _build_registry(registry: CollectorRegistry) -> None:
    ...
    registry.register("leilosil", LeilosilCollector, implemented=True)
    registry.register("leiloversatil", LeiloversatilCollector, implemented=True)
    registry.register("imovirtual", ImovirtualCollector, implemented=True)
    registry.register("olx", OlxCollector, implemented=True)
